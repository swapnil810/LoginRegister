package swapnil.loginregisters.sql;
...
import swapnil.loginregisters.model.User;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            ...
            + PROFILE_PIC + " BLOB,"
            + COLUMN_USER_CONTACT + " TEXT," + COLUMN_USER_PASSWORD + " TEXT" + ")";
    ...
    public void addUser(User user) {
        ...
        values.put(PROFILE_PIC,user.getImage());
        // Inserting Row
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setImage(cursor.getBlob(cursor.getColumnIndex(PROFILE_PIC)));
